...
/// Wraps a raw function as a `Parser`. Used by `compile_parser!` to store
/// generated specialized parse functions inside a standard `Parser` value.
#[doc(hidden)]
...
/// Cursor advance helper exposed for code generated by `compile_parser!` and
/// the `defparsec!` family. Not part of the public combinator API.
#[doc(hidden)]
pub fn __advance(cursor: Cursor, consumed: &str) -> Cursor {
